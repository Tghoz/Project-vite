                ...
                <ModalBody>
                  <form
                    ...
                    <div className="flex gap-2">
                      <Input type="nombre" {...register('nombre')}
                       label="Nombre"
                        className="max-w-xs" />
                      <Input
                        type="apellido" {...register('Apellido')}
                        label="Apellido"
                        className="max-w-xs"/>
                  ...
                  <div className="flex gap-2">
                    <Input
                      label="Documento de Identidad" {...register('Documento de identidad')}
                      ...
                      type="text" />
                    <Input
                      label="Numero de Contacto" {...register('Numero')}
